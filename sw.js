...
//var myCacheVersion = "v.1.2.2024.12.02";
...
e.waitUntil(caches.open("v.1.2.2024.12.02").then((cache) => cache.addAll(fileListArrFound)),);
});*/
...
"/pages/art/2024/ladybug-gimp-19.png",
...
this.addEventListener("activate", (event) => {
  const cachesToKeep = ["v.1.2.2024.12.02"];
