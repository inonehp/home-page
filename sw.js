...
//var myCacheVersion = "v.1.2.2024.03.01";
...
e.waitUntil(caches.open("v.1.2.2024.03.01").then((cache) => cache.addAll(fileListArrFound)),);
});*/
...
"/firefox-extensions/hotkey-url-5/light.css",
...
"/firefox-extensions/new-tab-redirect-3/light.css",
...
"/firefox-extensions/url-redirect-6/6-firefox-url-redirect-abc.zip",
...
"/firefox-extensions/url-redirect-6/light.css",
...
"/firefox-extensions/url-redirect-6/style-main.css",
...
this.addEventListener("activate", (event) => {
  const cachesToKeep = ["v.1.2.2024.03.01"];
