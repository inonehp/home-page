...
//var myCacheVersion = "v.1.2.2025.02.25";
...
e.waitUntil(caches.open("v.1.2.2025.02.25").then((cache) => cache.addAll(fileListArrFound)),);
});*/
...
this.addEventListener("activate", (event) => {
  const cachesToKeep = ["v.1.2.2025.02.25"];
