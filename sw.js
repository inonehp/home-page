...
//var myCacheVersion = "v.1.2.2024.03.04";
...
e.waitUntil(caches.open("v.1.2.2024.03.04").then((cache) => cache.addAll(fileListArrFound)),);
});*/
...
this.addEventListener("activate", (event) => {
  const cachesToKeep = ["v.1.2.2024.03.04"];
