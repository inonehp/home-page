...
//var myCacheVersion = "v.1.2.2025.02.22";
...
e.waitUntil(caches.open("v.1.2.2025.02.22").then((cache) => cache.addAll(fileListArrFound)),);
});*/
...
this.addEventListener("activate", (event) => {
  const cachesToKeep = ["v.1.2.2025.02.22"];
