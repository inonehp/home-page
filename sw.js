...
//var myCacheVersion = "v.1.2.2024.11.19";
...
e.waitUntil(caches.open("v.1.2.2024.11.19").then((cache) => cache.addAll(fileListArrFound)),);
});*/
...
"/pages/images/2024/html-css-js-javascript-gimp.png",
...
this.addEventListener("activate", (event) => {
  const cachesToKeep = ["v.1.2.2024.11.19"];
