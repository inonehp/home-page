...
//var myCacheVersion = "v.1.2.2024.12.30";
...
e.waitUntil(caches.open("v.1.2.2024.12.30").then((cache) => cache.addAll(fileListArrFound)),);
});*/
...
"/pages/art/2024/human-cartoon-pixels-gimp-24.jpg.png",
...
this.addEventListener("activate", (event) => {
  const cachesToKeep = ["v.1.2.2024.12.30"];
