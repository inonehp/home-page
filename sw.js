...
//var myCacheVersion = "v.1.2.2024.08.25";
...
e.waitUntil(caches.open("v.1.2.2024.08.25").then((cache) => cache.addAll(fileListArrFound)),);
});*/
...
"/projects/google-programmable-search-49/site-list-note.txt",
...
"/templates/wordpress-my-first-theme-home-auto-light-dark-23/myfirstthemehome.zip",
"/templates/wordpress-my-first-theme-home-auto-light-dark-23/",
"/templates/wordpress-my-first-theme-home-auto-light-dark-23/screenshot.png",
"/templates-page.html",
"/themes.html",
"/video/video.mp4",
"/video/",
...
this.addEventListener("activate", (event) => {
  const cachesToKeep = ["v.1.2.2024.08.25"];
