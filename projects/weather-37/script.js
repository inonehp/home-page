...
if(logJSONData != ""){ result[0] += '<div class="border padding2 bg3 borderRadius2"><h2>'+jsonData['current_weather']['temperature']+'°C, '+jsonData['current_weather']['windspeed']+'Km/h </h2>'+`
